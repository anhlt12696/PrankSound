...
import com.prank.sound.hair.cut.ps.pranksound.Activity.FeedbackActivity
import com.prank.sound.hair.cut.ps.pranksound.R
import com.prank.sound.hair.cut.ps.pranksound.databinding.FragmentSettingBinding
...
class SettingFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.swVibrate.setOnCheckedChangeListener { buttonView, isChecked ->
            if (isChecked) {
